#!/usr/bin/env python3
"""
This module provides functions for "drawing" lines,
rectangles, and text on the grid, and for rendering
the grid onto the console.
...
def add_text(row, column, text, char=None):
    """Adds a string for text to the grid
